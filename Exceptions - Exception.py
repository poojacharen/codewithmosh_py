...
# When writing programs, many things can go wrong. Our programs may encounter an error and terminate. Usually these errors happen because of programmers mistake, or bad data that we get from the user.
...
# It's our job as a programmer to prevent our application from crashing in this kind of situations. Instead we want to display a proper error message to the user. Like, this file doesn't exists
# some eg's are:
# Eg : 1
# numbers = [1, 2]
